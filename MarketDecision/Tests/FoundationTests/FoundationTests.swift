...
@Suite struct MoneyTests {
    ...
    func halfEven(_ pair: [String]) throws {
        try #require(pair.count == 2, "A rounding fixture requires input and expected result")
        #expect(try Money(pair[0]).posted() == Money(pair[1]))
    }
...
@Suite struct PersistenceTests {
    @Test func migrationReopensWithoutErasing() throws {
        ...
        #expect(try DatabaseStore(path: path).migrationVersions() == ["business.p1.v1", "business.p1.v2", "business.p1.v3", "business.p1.v4", "business.p1.v5", "business.p1.v6", "foundation.v1"])
        #expect(try DatabaseStore(path: path).migrationVersions() == ["business.p1.v1", "business.p1.v2", "business.p1.v3", "business.p1.v4", "business.p1.v5", "business.p1.v6", "foundation.v1"])
    }

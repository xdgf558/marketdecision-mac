...
@Suite struct MigrationFoundationTests {
    ...
    @Test func migrationFailurePreservesPriorRowsAndSuccessfulHistoryThenCanRetry() throws {
        ...
        #expect(try reopened.migrationVersions() == ["business.p1.v1","business.p1.v2","business.p1.v3","business.p1.v4","business.p1.v5","business.p1.v6","foundation.v1","synthetic.v1"])
        ...
        #expect(try DatabaseStore(path: path, migrations: [first, successful]).migrationVersions() == ["business.p1.v1","business.p1.v2","business.p1.v3","business.p1.v4","business.p1.v5","business.p1.v6","foundation.v1","synthetic.v1","synthetic.v2"])
    }
    @Test func phaseOneSchemaUpgradesFoundationDatabaseWithoutErasingExistingRows() throws {
        ...
        #expect(try upgraded.migrationVersions() == ["business.p1.v1", "business.p1.v2", "business.p1.v3", "business.p1.v4", "business.p1.v5", "business.p1.v6", "foundation.v1"])
    ...
    @Test func unknownOrNonprefixMigrationHistoryIsRejectedBeforeUpgrading() throws {
        ...
        #expect(try store.migrationVersions() == ["business.p1.v1","business.p1.v2","business.p1.v3","business.p1.v4","business.p1.v5","business.p1.v6","foundation.v1","future.v9"])
